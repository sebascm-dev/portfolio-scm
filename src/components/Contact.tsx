    ...
    return (
        <div className='mx-auto max-w-[90%]'>
            ...
            <form ref={form} onSubmit={sendEmail} className="p-10 h-[40em] mb-8 bg-[#373737] rounded-md shadow-md w-full sm:w-1/3 flex-grow">
                    ...
                    <input type="text" name="user_name" className="w-full px-3 py-2 mb-3 text-sm leading-tight focus:ring-2 focus:ring-[#F5B041] transition-all duration-500 text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" />
                    <label className="block mb-2 text-sm font-bold">Email</label>
                    <input type="email" name="user_email" className="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:ring-2 focus:ring-[#F5B041] transition-all duration-500 focus:shadow-outline" />
                    <label className="block mb-2 text-sm font-bold">Message</label>
                    <textarea name="message" className="w-full h-auto px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:ring-2 focus:ring-[#F5B041] transition-all duration-500 focus:shadow-outline" />
                    <input type="submit" value="Send" className="w-full px-4 py-2 mt-2 mb-4 font-bold text-white bg-[#F5B041] hover:bg-yellow-700 cursor-pointer transition-all duration-500 rounded-md focus:outline-none focus:shadow-outline" />
